...
class Topic:
    def __init__(self, _id, title: str = '', lesson_setting: LessonSetting = None, generated_at: datetime = None, parent_id = None, narrative = None, slides = None, summary = None, raw_topic = None):
        self.id = str(_id)
        self.title = title
